...
export const strategies = {
    ...
    move: {
        placeholder: null,
        prepare(dragging) {
            // Placeholder statt clone (leichter, keine events)
            this.placeholder = document.createElement('div');
            this.placeholder.className = 'drag-placeholder';
            this.placeholder.style.height = dragging.offsetHeight + 'px';
            this.placeholder.style.width = dragging.offsetWidth + 'px';
            dragging.parentNode.insertBefore(this.placeholder, dragging);
        ...
        move(zone, position, element) {
            ...
            if (element) {
                zone.insertBefore(dnd.dragged, position === 'before' ? element : element.nextElementSibling);
            } else {
                zone.appendChild(dnd.dragged);
            }
        },
        finalize() {
        ...
        cancel() {
            // Zurück zum Placeholder
            if (this.placeholder && dnd.dragged) {
                this.placeholder.parentNode.insertBefore(dnd.dragged, this.placeholder);
            }
            this.placeholder?.remove();
            this.placeholder = null;
        }
    ...
    ghost: {
        ...
        move(zone, position, element) {
            ...
            if (element) {
                zone.insertBefore(this.clone, position === 'before' ? element : element.nextElementSibling);
            } else {
                zone.appendChild(this.clone);
            }
        },
        finalize() {
            // Clone wird zum echten Element
            if (this.clone && dnd.dragged) {

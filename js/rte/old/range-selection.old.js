const oSelection = getSelection();

export function range(oRange) {
...
Object.assign(range.prototype, setters);

export function selection() {
	if (!oSelection.rangeCount) return false;
	if (!(this instanceof selection)) return new selection();
	this.oR = oSelection.getRangeAt(0);
};

selection.prototype = new range();
...
range.prototype.splitTextNodes = function() {
	var node = this.oR.startContainer;
	if (node.data) {

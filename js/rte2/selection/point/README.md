...
`point.js` represents one DOM boundary and its affinity. Internally it owns a
collapsed native `Range`, allowing the browser to relocate the point through
text splits, removals, and many other DOM mutations without marker elements.

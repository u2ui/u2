...
`repair-planner.js` decides how one direct parent/child relationship should be
normalized. Planning is pure: it inspects the current DOM and returns an
immutable action without changing nodes, selections, or transaction state.

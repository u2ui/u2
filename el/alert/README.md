...
```html
<link href="https://cdn.jsdelivr.net/gh/u2ui/u2@main/el/alert/alert.css" rel=stylesheet>
<script src="https://cdn.jsdelivr.net/gh/u2ui/u2@main/el/alert/alert.js" type=module async></script>
```

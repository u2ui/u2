...
```html
<link href="https://cdn.jsdelivr.net/gh/u2ui/u2@x.x.x/el/responsive/responsive.min.css" rel=stylesheet>
<script src="https://cdn.jsdelivr.net/gh/u2ui/u2@x.x.x/el/responsive/responsive.min.js" type=module async></script>
```

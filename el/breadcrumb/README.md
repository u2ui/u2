...
```html
<link href="https://cdn.jsdelivr.net/gh/u2ui/u2@x.x.x/el/breadcrumb/breadcrumb.css" rel=stylesheet>
<script src="https://cdn.jsdelivr.net/gh/u2ui/u2@x.x.x/el/breadcrumb/breadcrumb.js" type=module async></script>
```

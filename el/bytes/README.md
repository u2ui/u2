...
```html
<link href="https://cdn.jsdelivr.net/gh/u2ui/u2@x.x.x/el/bytes/bytes.css" rel=stylesheet>
<script src="https://cdn.jsdelivr.net/gh/u2ui/u2@x.x.x/el/bytes/bytes.js" type=module async></script>
```

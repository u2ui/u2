...
```html
<link href="https://cdn.jsdelivr.net/gh/u2ui/u2@main/el/code/code.css" rel=stylesheet>
<script src="https://cdn.jsdelivr.net/gh/u2ui/u2@main/el/code/code.js" type=module async></script>
```
